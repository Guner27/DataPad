This is my new [**React Native**](https://reactnative.dev) project, bootstrapped using [`@react-native-community/cli`](https://github.com/react-native-community/cli).
I created to learn react native framework, DataPad is a React Native App that include a simple **CRUD** operations  provide contact with **REST API**.
...
To install Node Modules(NPM packages), run the following command from the _root_ of the React Native project:
